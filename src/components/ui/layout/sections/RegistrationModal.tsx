      ...
      <motion.div
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            <h3 id="reg-modal-title" className="font-display font-bold text-xl sm:text-2xl text-white leading-tight tracking-tight">
              Register for TEDxUNM 2026
            </h3>
            <p className="text-xs text-gray-400 mt-1">
              Fill in your details to secure your TEDxUNM 2026 ticket.
            </p>
          </div>
          <button
        ...
        {status === 'success' ? (
          <div className="text-center py-6">
            ...
            <p className="text-xs text-gray-400">Please follow the official payment instructions after registration.</p>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <div className="pt-1">
              ...
              >
                ...
                <p className="flex items-start gap-2">
                  <span className="text-[#E10600] font-bold shrink-0">•</span>
                  <span><strong className="text-white font-semibold">Ticket Transfer:</strong> Tickets may be transferred to another person by confirming with the committee no later than H-1 before the event.</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-[#E10600] font-bold shrink-0">•</span>
                  <span><strong className="text-white font-semibold">Replacement Attendee:</strong> A replacement attendee must bring the required identification for verification.</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-[#E10600] font-bold shrink-0">•</span>
                  <span><strong className="text-white font-semibold">Check-in:</strong> Show your ticket or registration proof at check-in.</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-[#E10600] font-bold shrink-0">•</span>
                  <span><strong className="text-white font-semibold">Documentation Consent:</strong> By entering the event area, attendees consent to photo and video documentation during the event.</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-[#E10600] font-bold shrink-0">•</span>
                  <span><strong className="text-white font-semibold">Attendance & Conduct:</strong> Attendees are expected to participate throughout the event and follow all applicable rules and guidelines.</span>
                </p>
              </div>
              ...
              <label className="text-xs text-gray-300 flex items-start gap-2.5 cursor-pointer mt-3 select-none">
                ...
                />
                <span>Saya telah membaca dan menyetujui seluruh Terms and Conditions di atas.</span>
              </label>
            </div>

            {status === 'error' && (
              <p className="text-xs text-red-400 text-center">
                Registration could not be submitted. Please try again or contact the TEDxUNM committee.
              </p>
            )}
